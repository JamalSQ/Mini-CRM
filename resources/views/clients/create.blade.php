<x-layouts.app>
    <div class="container pt-2">
        <div class="row justify-content-center">
            <div class="col-12 col-md-12 col-lg-12"> <!-- More compact width -->
                ...
                <div class="card shadow-sm border-0 rounded-3">
                    <div class="card-header bg-white border-bottom text-center py-2 px-3">
                        <h2 class="h5 mb-0 fw-bold text-primary">Add New Client</h2>
                    </div>
                    <div class="card-body p-3"> <!-- Less padding for compactness -->
                        ...
                        <form action="{{ Route('clients.store') }}" method="POST" class="needs-validation ajax-form" enctype="multipart/form-data" novalidate>
                            ...
                            <div class="d-flex justify-content-end mt-3 gap-2">
                                <button type="submit" class="btn btn-primary btn-sm px-3">Add Client</button>
